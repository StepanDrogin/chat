    ...
    <main className="min-h-screen bg-canvas text-ink">
      <div className="grid min-h-screen lg:grid-cols-[minmax(360px,460px)_1fr]">
          ...
          <div>
            <div className="mb-10 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-teal-600 text-white shadow-message">
              ...
              <span className="ui-span rounded-lg border border-teal-100 bg-teal-50 px-3 py-1 text-sm font-medium text-teal-700">
                live
              </span>
            </div>
            ...
            <section className="surface-panel rounded-lg p-6">
              ...
              {!hasFirebaseConfig ? (
                <div className="mt-5 flex gap-3 rounded-lg border border-coral-500/30 bg-coral-50 p-4 text-sm leading-6 text-coral-600">
              ...
              <button
                className="ui-button mt-6 w-full bg-teal-600 px-5 py-3 text-white shadow-message hover:bg-teal-700"
        ...
        <section className="hidden min-h-screen px-8 py-7 lg:flex">
          <div className="surface-panel flex min-h-0 w-full flex-col rounded-lg">
            ...
            <div className="grid flex-1 grid-cols-[1fr_280px]">
              <div className="space-y-7 px-8 py-8">
                {previewMessages.map((message) => (
                  <article
                    className={`flex ${message.tone === 'own' ? 'justify-end' : 'justify-start'}`}
                    key={`${message.author}-${message.text}`}
                  >
                    <div
                      className={`max-w-md rounded-lg px-5 py-4 ${
                        message.tone === 'own'
